...
extension UIView {
    ...
    open func fillSuperview(padding: UIEdgeInsets = .zero) -> AnchoredConstraints {
        ...
        guard let superviewTopAnchor = superview?.topAnchor,
              ...
              let superviewTrailingAnchor = superview?.trailingAnchor else { return anchoredConstraints }
    ...
    @discardableResult
    open func constraintWidth(_ constant: CGFloat) -> AnchoredConstraints {
    ...
    @discardableResult
    open func constraintHeight(_ constant: CGFloat) -> AnchoredConstraints {
    ...
    @discardableResult
    open func constraintSize(_ constant: CGSize) -> AnchoredConstraints {
